...
######################################33 ORBITAS X vs Y
    ...
    plt.title ("VX vs VY")
    plt.legend()
    plt.savefig("Velocity_euler_dt_"+str(i)+"e-3.png")
    ...
    plt.title ("VX vs VY")
    plt.legend()
    plt.savefig("Velocity_leap_dt_"+str(i)+"e-3.png")
    ...
    plt.title ("VX vs VY")
    plt.legend()
    plt.savefig("Velocity_runge_dt_"+str(i)+"e-3.png")
    ...
    plt.legend ()
    plt.savefig("Energia_euler_dt_"+str(i)+"e-3.png")
    ...
    plt.title("Energia vs Tiempo")
    plt.legend ()
    plt.savefig("Energia_leap_dt_"+str(i)+"e-3.png")
    ...
    plt.title("Energia vs Tiempo")
    plt.legend ()
    plt.savefig("Energia_runge_dt_"+str(i)+"e-3.png")
    ...
    plt.legend ()
    plt.savefig("Angular_euler_dt_"+str(i)+"e-3.png")
    ...
    plt.title("Momento angular vs Tiempo")
    plt.legend ()
    plt.savefig("Angular_leap_dt_"+str(i)+"e-3.png")
    ...
    plt.title("Momento angular vs Tiempo")
    plt.legend ()
    plt.savefig("Angular_runge_dt_"+str(i)+"e-3.png")
